<x-layouts.app>
    <x-slot:title>Novo Produto | Estoque</x-slot:title>
    ...
    <div class="mb-4">
        ...
        <h1 class="text-primary fw-bold mt-4" style="font-size: 1.75rem;">Adicionar Produto</h1>
    </div>

    <x-ui.card>
        <x-slot:header>Preencha os dados técnicos</x-slot:header>
        ...
        <form action="{{ route('inventory.products.store') }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
                ...
                <div>
                    ...
                    <input type="text" name="sku" value="{{ old('sku') }}" style="width: 100%; padding: 0.75rem; border: 1px solid #e2e8f0; border-radius: 6px; outline: none;" placeholder="PROD-0001">
                ...
                <div>
                    ...
                    <input type="text" name="barcode" value="{{ old('barcode') }}" style="width: 100%; padding: 0.75rem; border: 1px solid #e2e8f0; border-radius: 6px; outline: none;">
                ...
                <div>
                    ...
                    <input type="text" name="cost_price" value="{{ old('cost_price', '0,00') }}" required style="width: 100%; padding: 0.75rem; border: 1px solid #e2e8f0; border-radius: 6px; outline: none;" placeholder="ex: 15,50">
                ...
                <div>
                    ...
                    <input type="text" name="sale_price" value="{{ old('sale_price', '0,00') }}" required style="width: 100%; padding: 0.75rem; border: 1px solid #e2e8f0; border-radius: 6px; outline: none;" placeholder="ex: 35,90">
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <textarea name="description" rows="3" style="width: 100%; padding: 0.75rem; border: 1px solid #e2e8f0; border-radius: 6px; outline: none; resize: vertical;">{{ old('description') }}</textarea>
            </div>
            ...
            <div style="text-align: right; border-top: 1px solid #e2e8f0; padding-top: 1.5rem;">
                ...
                <button type="submit" class="btn btn-primary" style="padding: 0.6rem 2rem;">Gravar Produto</button>
            </div>
        </form>
    </x-ui.card>
</x-layouts.app>
