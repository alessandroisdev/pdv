<aside class="app-layout__sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <li>
            <a href="{{ route('finance.dashboard') }}" class="sidebar-link {{ request()->routeIs('finance.*') && !request()->routeIs('finance.reports.*') ? 'sidebar-link--active' : '' }}">
                <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                <span>Dashboard Financeiro</span>
            </a>
        </li>
        <li>
            <a href="{{ route('finance.reports.index') }}" class="sidebar-link {{ request()->routeIs('finance.reports.*') ? 'sidebar-link--active' : '' }}">
                <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                <span>Métricas & Relatórios</span>
            </a>
        </li>
        <li>
            <a href="{{ route('finance.installments.index') }}" class="sidebar-link {{ request()->routeIs('finance.installments.*') ? 'sidebar-link--active' : '' }}">
        ...
        <li>
            <a href="{{ route('hr.employees.index') }}" class="sidebar-link {{ request()->routeIs('hr.employees.*') ? 'sidebar-link--active' : '' }}">
        ...
        <li>
            <a href="{{ route('settings.standby.index') }}" class="sidebar-link {{ request()->routeIs('settings.standby.*') ? 'sidebar-link--active' : '' }}">
                <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>
                <span>Standby & Sinalização Mídia</span>
            </a>
        </li>
        <li>
        ...
        <li style="margin-top: 2rem;">
            <a href="{{ route('fiscal.records.index') }}" class="sidebar-link {{ request()->routeIs('fiscal.records.*') ? 'sidebar-link--active' : '' }}" style="border-top: 1px solid rgba(255,255,255, 0.1); border-radius: 0;">
                ...
                <span>Histórico Fiscal (XMLs)</span>
            </a>
        </li>
        <li>
            <a href="{{ route('fiscal.sandbox') }}" class="sidebar-link {{ request()->routeIs('fiscal.sandbox*') ? 'sidebar-link--active' : '' }}" style="border-radius: 0;">
                <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path></svg>
                <span>Laboratório Fiscal (NFC-e)</span>
            </a>
        </li>
        <li>
            <a href="{{ route('settings.users.index') }}" class="sidebar-link {{ request()->routeIs('settings.users.*') ? 'sidebar-link--active' : '' }}">
                <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                <span>Usuários & Controle de Acesso</span>
            </a>
        </li>
        <li>
        ...
        <li>
            <a href="{{ route('core.help.index') }}" class="sidebar-link {{ request()->routeIs('core.help.*') ? 'sidebar-link--active' : '' }}">
